...
export function postCatagories(
  catagoryRequest: CatagoryRequest,
  opts?: Oazapfts.RequestOpts
) {
  return oazapfts.fetchJson<
    | {
...
export function putCatagoriesById(
  id: string,
  catagoryRequest: CatagoryRequest,
  opts?: Oazapfts.RequestOpts
) {
...
export function putFeedbacksById(
  id: string,
  feedbackRequest: FeedbackRequest,
  opts?: Oazapfts.RequestOpts
) {
...
export function getLikesById(id: string, opts?: Oazapfts.RequestOpts) {
  return oazapfts.fetchJson<
    | {
        status: 200;
        data: LikeResponse;
...
export function deleteLikesById(id: string, opts?: Oazapfts.RequestOpts) {
  return oazapfts.fetchJson<
    | {
        status: 200;
        data: number;
...
export function getPortfolioMessages(
  {
    sort,
    paginationWithCount,
    paginationPage,
...
export function postPortfolioMessages(
  portfolioMessageRequest: PortfolioMessageRequest,
  opts?: Oazapfts.RequestOpts
) {
  return oazapfts.fetchJson<
    | {
...
export function getPortfolioMessagesById(
  id: string,
  opts?: Oazapfts.RequestOpts
) {
  return oazapfts.fetchJson<
...
export function putPortfolioMessagesById(
  id: string,
  portfolioMessageRequest: PortfolioMessageRequest,
  opts?: Oazapfts.RequestOpts
) {
...
export function deletePortfolioMessagesById(
  id: string,
  opts?: Oazapfts.RequestOpts
) {
  return oazapfts.fetchJson<
 ...
 * Get a role
 */
export function getUsersPermissionsRolesById(
  {
    id,
  }: {
    id?: any;
 ...
 * Update a role
 */
export function putUsersPermissionsRolesByRole(
  body: {
    name?: string;
    description?: string;
    type?: string;
 ...
 * Delete a role
 */
export function deleteUsersPermissionsRolesByRole(
  {
    role,
  }: {
    role?: any;
...
export function getAuthEmailConfirmation(
  ...
  >(
    `/auth/email-confirmation${QS.query(
      QS.form({
        confirmation,
      })
    )}`,
